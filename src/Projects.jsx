...
const projects = [
  {
    ...
    technologies: [<FaReact key="react" />, <SiTailwindcss key="tailwind" />, <SiJavascript key="js" />],
  },
  {
    id: 2,
    title: "Slots Machine",
    ...
    technologies: [<FaCss3Alt key="CSS" />, <FaHtml5 key="HTML" />, <SiJavascript key="js" />],
  },
  {
    id: 3,
  ...
  return (
    <section className="relative w-full min-h-screen overflow-hidden bg-gray-900 py-20 px-4 md:px-12 lg:px-20 xl:px-32 text-white">
      ...
      <div className="relative max-w-screen-2xl mx-auto z-10 ">
        ...
        >
         <span className = "text-4xl lg:text-5xl font-bold font-ubuntu text-center mb-16 bg-gradient-to-r from-amber-400 to-pink-500 bg-clip-text text-transparent">Projects</span>  🚀
        </motion.h2>
          ...
          {projects.map((project, index) => (
            ...
            >
              ...
              <div className="lg:w-3/5 w-full p-6 md:p-10 space-y-5 bg-gray-900">
                <h3 className="text-2xl md:text-3xl font-semibold text-secondaryText group-hover:text-transparent group-hover:bg-clip-text group-hover:bg-gradient-to-r from-yellow-300 via-pink-500 to-purple-600 transition duration-300 font-ubuntu">
                  {project.title}
                </h3>
                <p className="text-text3 text-md md:text-lg font-lora font-bold">{project.description}</p>
